 ...
 * @since 2022/11/5
 */
@Service("manual_merge")
@Slf4j
@RequiredArgsConstructor
public class ManualAlarmSelectImpl implements AlarmSelect {
    ...
    public AlarmSelectType type() {
        return AlarmSelectType.manual_merge;
    }

    @Override
    public SearchResponse selectAlarmIndexingList(QueryCondition condition) {
        SearchRequest request = new SearchRequest(EsIndex.ALARM_INDEXING_MANUAL);
    ...
    public SearchResponse selectAlarmEventListByAlarmIndexingId(QueryCondition condition) {
        // es search ///////////////////////////////
        SearchRequest request = new SearchRequest(EsIndex.ALARM_EVENT_MANUAL);
