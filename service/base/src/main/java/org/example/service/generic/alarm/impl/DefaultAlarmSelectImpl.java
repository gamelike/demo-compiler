...
@Slf4j
public class DefaultAlarmSelectImpl implements AlarmSelect {
    ...
    public AlarmSelectType type() {
        return AlarmSelectType.normal;
    }

    @Override
    public SearchResponse selectAlarmIndexingList(QueryCondition condition) {
        SearchRequest request = new SearchRequest(EsIndex.ALARM_INDEXING);
    ...
    public SearchResponse selectAlarmEventListByAlarmIndexingId(QueryCondition condition) {
        // es search ///////////////////////////////
        SearchRequest request = new SearchRequest(EsIndex.ALARM_EVENT);
